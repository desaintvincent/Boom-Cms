...
var js_site_files = ['Static/src/js/libs/jquery.min.js', 'Static/src/js/libs/foundation.min.js', 'Static/src/js/libs/*.js', 'Static/src/js/site.js', 'Apps/**/Static/src/js/*.js'];
var js_site_dest = 'Static/dist/js';

var js_admin_files = ['Static/src/js/libs/jquery.min.js','Static/src/js/libs/bootstrap.min.js', './Apps/Admin/Static/js/libs/*.js', './Apps/Admin/Static/js/libs/colorpicker.js', './Apps/Admin/Static/js/components/*.js', './Apps/Admin/Static/js/admin.js'];
...
gulp.task('default',function() {
    //sass site
    gulp.watch(['Static/src/sass/components/*.scss', 'Static/src/sass/site.scss', 'Apps/**/Static/src/sass/*.scss'],['sass_site']);
    //sass admin
    gulp.watch(['Apps/Admin/Static/sass/components/*.scss', 'Apps/Admin/Static/sass/admin.scss'],['sass_admin']);
    //js site
    gulp.watch(js_site_files,['uglify_site']);
    //js admin
    gulp.watch(['Apps/Admin/Static/js/libs/*.js', 'Apps/Admin/Static/js/components/*.js', 'Apps/Admin/Static/js/admin.js'],['uglify_admin']);
});