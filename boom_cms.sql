...
--
-- Client :  localhost
-- Généré le :  Mar 27 Septembre 2016 à 23:35
...
INSERT INTO `menus` (`id`, `menu_title`) VALUES
(1, 'menu principaleuh');
...
INSERT INTO `menu_items` (`id`, `mitem_parent_id`, `mitem_display_order`, `mitem_menu_id`, `mitem_title`, `mitem_arg`, `mitem_type`) VALUES
...
(1, 'admin', 'admin', 'admin', '90b9aa7e25f80cf4f64e990b78a9fc5ebd6cecad', '25065e12be6e15f6666873fb290eb343dc5e5db5');
